<p>
  <img src="banner.png" alt="pi-minions" width="1100">
</p>
...
`pi-minions` reads optional JSON config from `~/.pi/agent/extensions/subagent/config.json`.
